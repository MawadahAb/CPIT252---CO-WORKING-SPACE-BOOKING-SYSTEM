...
public class main {
    ...
    static WorkspaceInventory inventory =
            new WorkspaceInventory();

    static ArrayList<BookingContext> bookings =
            new ArrayList<>();
    ...
    public static Workspace chooseWorkspace() {
        ...
        if (workspaceChoice == 1) {
            ...
            return workSpaceFactory
                    .createWorkspace("PrivateOffice");

        } else if (workspaceChoice == 2) {

            return workSpaceFactory
                    .createWorkspace("SmallMeetingRoom");

        } else if (workspaceChoice == 3) {

            return workSpaceFactory
                    .createWorkspace("MediumMeetingRoom");

        } else if (workspaceChoice == 4) {

            return workSpaceFactory
                    .createWorkspace("LargeMeetingRoom");

        } else if (workspaceChoice == 5) {

            return workSpaceFactory
                    .createWorkspace("OpenSpace");
    ...
    public static void bookingProcessMenu(
            BookingContext booking
    ) {
        ...
        while (running) {
            ...
            } else if (booking.getState()
                    instanceof CheckedInState) {
